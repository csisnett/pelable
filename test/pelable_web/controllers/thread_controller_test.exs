defmodule PelableWeb.ThreadControllerTest do
  use PelableWeb.ConnCase

  alias Pelable.Learn

  @create_attrs %{title: "some title", type: "some type", uuid: "7488a646-e31f-11e4-aace-600308960662"}
  ...
  def fixture(:thread) do
    {:ok, thread} = Learn.create_thread(@create_attrs)
    thread
  end
